package com.androidpractice.hiltdi.Login.components
...
fun UserNameField(
    ...
    OutlinedTextField(value = authState.userName, onValueChange = { onValueChanged(it) },
...
fun PasswordInputField(
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            ...
            {
                Icon(
                    imageVector = if (authState.togglePasswordVisibility) Icons.Default.Close else Icons.Default.Search,
